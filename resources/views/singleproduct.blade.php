                            ...
                            <div class="row align-items-center">
                                <div class="col-md-5">
                                    <div class="product-slider-single normal-slider">
                                        ...
                                        <img src="{{ asset('upload/images/product/'.$image->name) }}" alt="Product Image">
                                        @endforeach
                                    ...
                                    <div class="product-slider-single-nav normal-slider" style="height: 120px">
                                        @foreach ($product->productimages as $image)
                                        <div class="slider-nav-img"><img src="{{ asset('upload/images/product/'.$image->name) }}" alt="Product Image"></div>
                                        {{--  <img src="{{ asset('upload/images/product/'.$image->name) }}" alt="Product Image">  --}}
                                        @endforeach
{{--
                    ...
                    @foreach ($subCateproducts as $product)
                        ...
                        <div class="sidebar-widget category">
                            ...
                            <nav class="navbar bg-light">
                                <ul class="navbar-nav">
                                    ...
                                    {{--  <li><a href="#">{{ $category->name }} </a><span>(45)</span></li>  --}}
                                    {{--  <div class="brand-item"><img src="{{ asset('upload/images/subcategory/'.$category->image) }}" alt="">{{ $category->name }}</div>  --}}
                                    <li class="nav-item">
                                        <a class="nav-link" href="#"><i class="fa fa-mobile-alt"></i>{{ $category->name }}</a>
                                    </li>
                    ...
                    @endforeach
                        ...
                        <div class="sidebar-widget brands">
                            ...
                            <ul>
                                ...
                                <li><a href="{{  route('productListcate.show',[$category->name,$category->id])  }}">{{ $category->name }} </a><span>(45)</span></li>
                                {{--  <div class="brand-item"><img src="{{ asset('upload/images/subcategory/'.$category->image) }}" alt="">{{ $category->name }}</div>  --}}
                        ...
                        <div class="sidebar-widget tag">
                            ...
                            @foreach ($subCateproducts as $produ)

                            <a href="{{ route('produs.show',[$produ->id,$produ->subcategory_id]) }}">{{ $produ->name }}</a>
                            @endforeach
        ...
        <div class="brand">
            <div class="container-fluid">
                <div class="brand-slider">
                    @foreach ($subcategories as $category)
                    <a  href="{{  route('productListcate.show',[$category->name,$category->id])  }}" class="brand-item"><img src="{{ asset('upload/images/subcategory/'.$category->image) }}" alt="">{{ $category->name }}</a>
