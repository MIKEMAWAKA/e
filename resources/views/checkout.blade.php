                            ...
                            <div class="billing-address">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        {!! Form::text('fname', null, ['class' => 'form-control','maxlength' => 191,'required','maxlength' => 191,'maxlength' => 191]) !!}
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        {!! Form::text('phone', null, ['class' => 'form-control','required','maxlength' => 191,'maxlength' => 191,'maxlength' => 191]) !!}
                                    </div>
                                    <div class="col-md-12">
                                        <label>Address</label>
                                        {!! Form::text('address',  null, ['class' => 'form-control','maxlength' => 191,'maxlength' => 191,'required','maxlength' => 191]) !!}
                                    </div>
                                    {{--  <div class="col-md-6">
                                        <label>Country</label>
                    ...
                    <div class="col-lg-4">
                        <div class="checkout-inner">
                            <div class="checkout-summary">
                                ...
                                <input type="hidden" value="{{ $product->name}}" name="productname" type="text">
                                <input type="hidden" value="{{"TZS " . number_format($product->sale_price, 0, ",", ",")  }}" name="totalprice"  type="text">
                                <input type="hidden" value="{{"TZS " . number_format($product->sale_price, 0, ",", ",")  }}" name="itemprice"  type="text">
                                {{--  <input type="hidden"  type="text">  --}}

                                <p>Product Name<span>{{ $product->name}}<span></p>
                                <p class="sub-total">Sub Total<span>{{"TZS " . number_format($product->sale_price, 0, ",", ",")  }}</span></p>
                                <p class="ship-cost">Shipping Cost<span>Depending on location</span></p>
                                <h2>Grand Total<span>{{"TZS " . number_format($product->sale_price, 0, ",", ",")  }}</span></h2>
                                ...
                                <div class="payment-methods">
                                    ...
                                    <div class="payment-method">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label" for="payment-1">Mobile Money</label>
                                        </div>
